#
# This code appears to not be used.  A poster showing it is here
#
#   https://www.cgl.ucsf.edu/Research/projects/emdb/
#
...
class EMDBResultsDialog(ModelessDialog):
	...
	def fetch(self, pdb = False):
		t =  'EMDBFITID' if pdb else 'EMDBID'
                slist = self.resultsTable.selected()
                from chimera import openModels
                for e in slist:
			openModels.open(e['accessionCode'], type=t)
