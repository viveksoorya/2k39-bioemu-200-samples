...
# --- UCSF Chimera Copyright ---
#
# $Id: FileTypeMan.py 38342 2013-02-27 00:37:22Z gregc $
...
################################################
    ...
    def registerForWin(self, desc, exts, mime):
        ...
        cmd = u"\"%s\\chimera.exe\" \"--send\" \"%%1\"" % os.path.split(sys.executable)[0]
