...
# --- UCSF Chimera Copyright ---
#
# $Id: BrowserCfgGUI.py 38342 2013-02-27 00:37:22Z gregc $
...
class BrowserCfgGUI(WizShell):
    ...
    def createPanelTwo(self):
        ...
        self.scrTypeList.pack(side='bottom', anchor='n', fill='both', expand=True, pady=15, padx=10)
        ...
        self.types      = [ t for t in fi.types() if fi.mimeType(t) ]
