...
# --- UCSF Chimera Copyright ---
#
# $Id: tcl_sockets.py 36820 2012-07-05 20:57:32Z gregc $
...
if __name__ == '__main__':
	import Tkinter
	tk = Tkinter.Frame()
	server = Server(tk, None)
	t = tk.tk.call('fconfigure', server.socket_channel_id, '-sockname')
        print repr(t), t
	print server.getPortNo()
