...
def pipes_cmd(cmd_name, args):
	from PipesAndPlanks import cmd
	cmd.pp_cmd(cmd_name, args)

def unpipes_cmd(cmd_name, args):
	from PipesAndPlanks import cmd
	cmd.unpp_cmd(cmd_name, args)

from Midas import midas_text
midas_text.addCommand('pipes', pipes_cmd, unpipes_cmd)
