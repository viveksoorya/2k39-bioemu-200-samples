...
# --- UCSF Chimera Copyright ---
#
# $Id: VolumeDialog.py 39658 2014-04-08 22:58:19Z pett $

import Tkinter, Pmw
from chimera.baseDialog import ModelessDialog
from prefs import prefs, VOLUME_CUTOFF, VOLUME_RESOLUTION, VOLUME_ATOM_RADII_TREATMENT
import chimera
...
class VolumeDialog(ModelessDialog):
	...
	def fillInUI(self, parent):
		...
		from chimera.tkoptions import IntOption, BooleanOption, \
						FloatOption, StringOption, SymbolicEnumOption
		...
		class RadiiOption(SymbolicEnumOption):
			labels = ("points", "uniform VDW spheres", "center-weighted VDW spheres")
			values = ("ignored", "uniform", "weighted")
		self.radiiTreatment = RadiiOption(parent, 9, "Treat atoms as",
			prefs[VOLUME_ATOM_RADII_TREATMENT], None)
	...
	def Apply(self):
		...
		radiiTreatment = prefs[VOLUME_ATOM_RADII_TREATMENT] = self.radiiTreatment.get()
		if len(atomTypes) > 1:
