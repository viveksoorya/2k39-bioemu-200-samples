...
def sop_cmd(cmdname, args):
    from Surface import sopcommand as SC
    SC.sop_command(cmdname, args)
def unsop_cmd(cmdname, args):
    from Surface import sopcommand as SC
    SC.unsop_command(cmdname, args)
from Midas.midas_text import addCommand
addCommand('sop', sop_cmd, unsop_cmd, help = True)
