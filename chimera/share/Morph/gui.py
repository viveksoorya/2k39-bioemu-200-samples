...
class MorphDialog(ModelessDialog):
	...
	def fillInUI(self, parent):
		...
		self.coreCounter = Pmw.Counter(parent,
					hull_padx=2,
					labelpos="w",
					label_text="Core fraction:",
					datatype="real",
					increment=0.1,
	...
	def updateOptions(self, *args):
		...
		cf = self.coreCounter.component("entryfield")
		ef.setvalue(opts["core"])
	...
	def Apply(self):
		if (self.addDialog
		and self.addDialog.uiMaster().winfo_ismapped()):
