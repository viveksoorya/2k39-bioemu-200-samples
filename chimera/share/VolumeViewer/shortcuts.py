...
#
def outline_box():
  toggle_rendering_option('show_outline_box')

# -----------------------------------------------------------------------------
#
def solid_linear_interpolation():
  toggle_rendering_option('linear_interpolation')

# -----------------------------------------------------------------------------
#
def toggle_rendering_option(attrname):
  ...
  for v in vlist:
    if v.shown():
      kw = {attrname: not getattr(v.rendering_options, attrname)}
      v.set_parameters(**kw)
      v.show()
