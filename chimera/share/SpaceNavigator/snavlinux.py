...
class Space_Device_Linux:
    def __init__(self):
        ...
        if not path.exists('/var/run/spnav.sock'):
            # Avoid shell error message from spnav_open().
            raise EnvironmentError, 'spacenavd socket /var/run/spnav.sock does not exist'
