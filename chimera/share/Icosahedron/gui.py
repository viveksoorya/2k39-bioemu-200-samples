...
class Icosahedron_Dialog(ModelessDialog):
  ...
  def fillInUI(self, parent):
    ...
    # Orientation menu
    self.orient_222 = 'xyz 2-fold axes (222)'
    self.orient_222r = 'xyz 2-fold axes, alt (222r)'
    self.orient_2n3 = 'x 2-fold, z 3-fold (2n3)'
    self.orient_2n3r = 'x 2-fold, z 3-fold, alt (2n3r)'
    self.orient_2n5 = 'x 2-fold, z 5-fold (2n5)'
    self.orient_2n5r = 'x 2-fold, z 5-fold, alt (2n5r)'
    self.orient_n25 = 'y 2-fold, z 5-fold (n25)'
    self.orient_n25r = 'y 2-fold, z 5-fold, alt (n25r)'
    ...
    # Mesh line width
    lw = Hybrid.Entry(cf, '  Line width ', 3, '1')
    lw.frame.grid(row = 0, column = 2, sticky = 'w')
    self.line_width = lw.variable
    lw.entry.bind('<KeyPress-Return>', self.show_cb)
  ...
  def show_cb(self, event = None, model_id = None):
    ...
    from CGLtk import Hybrid
    line_width = Hybrid.float_variable_value(self.line_width, 1)
