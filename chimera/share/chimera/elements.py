...
# license details.
#
# $Id: elements.py 39076 2013-09-05 20:35:24Z pett $
...
Rf = Element(Element.Rf)
Db = Element(Element.Db)
Sg = Element(Element.Sg)
Bh = Element(Element.Bh)
Hs = Element(Element.Hs)
Mt = Element(Element.Mt)
Ds = Element(Element.Ds)
Rg = Element(Element.Rg)
...
nobleGases = set([He, Ne, Ar, Kr, Xe, Rn])
