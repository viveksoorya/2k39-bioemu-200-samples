...
class Searcher:
    def __init__(self):
        ...
        # Need to quote file name with repr() because SwishE.new accepts
        # a whitespace-separated list of index files.
        fname = self.index.encode('utf-8')
        self.swisher = SwishE.new(repr(fname))
    ...
    def doSearch(self, query):
        ...
        try:
            ...
            if str(e) == "No search words specified":
