...
# --- UCSF Chimera Copyright ---
#
# $Id: unknownsGUI.py 33307 2011-05-09 23:27:16Z pett $
...
class addHinfoDialog(ModelessDialog):
	...
	def fillInUI(self, parent):
		...
		self._geometriesList.grid(row=30, column=0, sticky='ns')
		...
		hull = self._substituentsList.component('hull')
		hull.rowconfigure(0, weight=1)
		hull.rowconfigure(1, weight=0)
		hull.rowconfigure(2, weight=0)
		self._substituentsList.grid(row=30, column=1, sticky='ns')
...
def initiateAddHyd(models, cancelCB=None, okCB=None,
					addFunc=AddH.hbondAddHydrogens, **kw):
