...
class SPIDER_Data:
  ...
  def __init__(self, path):
    ...
    # not used by SPIDER.
    if v['pixsiz'] > 1.0E-20:
      self.data_step = (v['pixsiz'], v['pixsiz'], v['pixsiz'])
    else:
  ...
  #
  # Modified by Image Science - Nov 2014:
  #
  def read_header_values(self, file):
    ...
    names = ('nslice', 'nrow', 'irec', 'nhistrec', 'iform', 'imami', 'fmax',
             ...
             'lenbyt', 'istack', 'unused1', 'maxim', 'imgnum', 'lastindx',
             'unused2', 'unused3', 'kangle', 'phi1', 'theta1', 'psi1',
             'phi2', 'theta2', 'psi2', 'pixsiz')
