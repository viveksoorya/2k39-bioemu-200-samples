...
class MRC_Data:
  ...
  def __init__(self, path, file_type):
    ...
    imod_file = v.get('imodStamp') == 1146047817
    if imod_file:
    ...
    if (v['type'] == 'mrc2000' and
      ...
      # zorigin are used.
      #
      o = (v['xorigin'], v['yorigin'], v['zorigin'])
# TODO: The following IMOD fix will make old Chimera session restore with wrong map position if origin is not zero.
#      if imod_file and v['imodFlags'] & 0x4 == 0:
        # Older IMOD MRC files used opposite sign for origin.
#        o = tuple(-x for x in o)	
      self.data_origin = o 
    else:
