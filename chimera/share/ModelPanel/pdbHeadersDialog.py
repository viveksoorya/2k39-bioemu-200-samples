...
# license details.
#
# $Id: pdbHeadersDialog.py 36021 2012-03-27 22:54:11Z pett $
...
class PDBHeadersDialog(ModelessDialog):
	...
	def fillInUI(self, parent):
		...
		if tkgui.windowSystem == "aqua":
			# kludge to allow text to be selected despite being disabled
			textWidget = self.text.component('text')
			textWidget.bind("<ButtonPress>", lambda e, t=textWidget: t.focus(), add=True)
