...
# --- UCSF Chimera Copyright ---
#
# $Id: gui.py 36324 2012-04-30 18:51:07Z pett $
...
class ClipDialog(ModelessDialog):
	...
	def fillInUI(self, parent):
		...
		Tkinter.Button(parent, text="Surface capping...", pady=0,
		...
		if self.clipVar.get():
			try:
				...
				replyobj.error("Model cannot currently be"
					...
					"Some part of a model must be displayed for clipping to work.\n"
					"Ensure you have chosen the right model to clip in the dialog's"
					" 'Model:' menu.\n")
