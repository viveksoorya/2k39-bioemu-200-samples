...
# --- UCSF Chimera Copyright ---
#
# $Id: OrderedListOption.py 39285 2013-11-18 18:48:09Z conrad $
...
class OrderedListFrame(Tkinter.Frame):
	...
	def __init__(self, master=None, **kw):
		...
		self.outline = OutlineLayout.OutlineLayout(self, self, **kw)
...
class OrderedListOption(OrderedListFrame):
	...
	def __init__(self, master=None, **kw):
		...
		listDict.update(kw)
		OrderedListFrame.__init__(self, master, **listDict)
		import Pmw
...
class OrderedFileListOption(OrderedListOption):
	...
	def __init__(self, *args, **kw):
		...
		OrderedListOption.__init__(self, *args, **kw)
...
class OrderedDirListOption(OrderedListOption):
	...
	def __init__(self, master=None, dirPrompt="Pick a directory",
		...
		OrderedListOption.__init__(self, master, **kw)
