...
# --- UCSF Chimera Copyright ---
#
# $Id: PrintPanel.py 39285 2013-11-18 18:48:09Z conrad $
...
class PrintPanel(ModalWindow):
	...
	def __init__(self, *args, **kw):
		ModalWindow.__init__(self, *args, **kw)
		self.optionDict = {}
		...
		self.printerMenuButton = Tk.OptionMenu(*args)
	...
	def _useOpenSave(self, title, extension, filetypes):
		...
		if not paths:
			...
			self.optionDict['destination'] = 'file'
			self.optionDict['file'] = paths[0][0]
			self.end(self.optionDict)
