...
# --- UCSF Chimera Copyright ---
#
# $Id: TextureEditor.py 39285 2013-11-18 18:48:09Z conrad $
...
class EditorTextureMap(TextureMap.TextureMap):
	...
	def __init__(self, master=None, editor=None, **kw):
		self.editor = editor
		TextureMap.TextureMap.__init__(self, master, **kw)
...
class EditorSolidSource(BlockSource.SolidBlockSource):
	...
	def __init__(self, master=None, editor=None, **kw):
		self.editor = editor
		BlockSource.SolidBlockSource.__init__(self, master, **kw)
...
class EditorBandedSource(BlockSource.BandedBlockSource):
	...
	def __init__(self, master=None, editor=None, **kw):
		self.editor = editor
		BlockSource.BandedBlockSource.__init__(self, master, **kw)
