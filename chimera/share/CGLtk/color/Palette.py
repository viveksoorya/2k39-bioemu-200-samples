...
# --- UCSF Chimera Copyright ---
#
# $Id: Palette.py 39285 2013-11-18 18:48:09Z conrad $
...
class RGB:
	...
	def ink(self, color):
		return Ink.RGB(*color)

	def grayLevel(self, color):
		return Ink.RGBgray(*color)
...
class HLS(Palette):
	...
	def ink(self, color):
		return Ink.HLS(*color)

	def grayLevel(self, color):
		return Ink.HLSgray(*color)

	def fromRGBA(self, rgba):
		hls = list(colorsys.rgb_to_hls(rgba[0], rgba[1], rgba[2]))
		if hls[1] == 0:
			hls[2] = 1
		return hls
...
class HSV(Palette):
	...
	def ink(self, color):
		return Ink.HSV(*color)

	def grayLevel(self, color):
		return Ink.HSVgray(*color)

	def fromRGBA(self, rgba):
		hsv = list(colorsys.rgb_to_hsv(rgba[0], rgba[1], rgba[2]))
		if hsv[2] == 0:
			hsv[1] = 1
		return hsv
...
class YIQ(Palette):
	...
	def ink(self, color):
		return Ink.YIQ(*color)

	def grayLevel(self, color):
		return Ink.YIQgray(*color)
...
class CMYK(Palette):
	...
	def ink(self, color):
		return Ink.CMYK(*color)

	def grayLevel(self, color):
		return Ink.CMYKgray(*color)
