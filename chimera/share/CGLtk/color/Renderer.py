...
# --- UCSF Chimera Copyright ---
#
# $Id: Renderer.py 39285 2013-11-18 18:48:09Z conrad $
...
class Renderer(ImageTk.PhotoImage):
	...
	def __init__(self, master, image, hasAlpha, **kw):
		...
		self.image = Image.new("RGB", self.alphaImage.size)
		ImageTk.PhotoImage.__init__(self, self.image, **kw)
		self.background = {}
		self.offset = 0
		self.afterId = None
		self.maxOffset = self.image.size[0] + min(*self.image.size)
		grayLevels = 32
