...
# --- UCSF Chimera Copyright ---
#
# $Id: prefs.py 39487 2014-01-25 01:30:14Z pett $
...
REGION_BALLOON_ON = "show region balloon help"
...
STARTUP_HEADERS = "headers shown at startup"
SHOW_RULER_AT_STARTUP = "startup ruler"
MODELLER_PATH = "Local modeller path"
MODELLER_KEY = "Modeller license key"
MODELLER_USE_WEB = "use Modeller web service"
MODELLER_TEMP_PATH = "Temp Modeller running path"
RB_LAST_USE = "last rb use"
...
REALIGN_DEST = "destination window for realigned seqs"
REALIGN_DEFAULT_SERVICE = "default realignment service"

CLUSTALO_ITERATIONS = "Clustal Omega --iterations"
CLUSTALO_FULL_INITIAL = "Clustal Omega --full"
CLUSTALO_FULL_ITERATION = "Clustal Omega --full-iter"

MUSCLE_ITERATIONS = "Muscle -maxiters"
MUSCLE_ITERATION_TIME = "Muscle -maxhours"
MUSCLE_DIAGONALS = "Muscle -diags"
MUSCLE_LOG = "Muscle -log (copy it to reply log)"
...
defaults = {
	...
	MODELLER_PATH: "mod9v9",
	MODELLER_KEY: "",
	MODELLER_USE_WEB: True,
	MODELLER_TEMP_PATH: "",
	REGION_BALLOON_ON: True,
	RB_LAST_USE: None,
	REALIGN_DEST: "new",
	REALIGN_DEFAULT_SERVICE: None,
	CLUSTALO_ITERATIONS: 1,
	CLUSTALO_FULL_INITIAL: True,
	CLUSTALO_FULL_ITERATION: True,
	MUSCLE_ITERATIONS: 16,
	MUSCLE_ITERATION_TIME: 0,
	MUSCLE_DIAGONALS: False,
	MUSCLE_LOG: True
}
