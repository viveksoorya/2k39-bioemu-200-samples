...
# --- UCSF Chimera Copyright ---
#
# $Id: EpsDialog.py 41172 2016-07-13 18:50:39Z pett $
...
class EpsDialog(SaveModeless):
	...
	def __init__(self, mav):
		...
		defaultFile = os.path.splitext(self.mav.title or "alignment")[0].replace(os.sep, ' ')
	...
	def fillInUI(self, parent):
		...
		Tkinter.Label(self.clientArea, text="Alignment appearance can be"
			u" adjusted with Preferences\N{RIGHTWARDS ARROW}Appearance\n"
			"(e.g. inter-column spaces can be removed)").grid(row=4,
