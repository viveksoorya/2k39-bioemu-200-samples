...
# --- UCSF Chimera Copyright ---
#
# $Id: __init__.py 39809 2014-05-15 18:19:02Z pett $
...
def readXYZ(fileName):
	...
	for line in f:
		...
		serial += 1
	f.close()
	if state in ("init", "post line 1"):
		raise UserError("File '%s' is not an XYZ file" % fileName)
	if not r.atoms:
