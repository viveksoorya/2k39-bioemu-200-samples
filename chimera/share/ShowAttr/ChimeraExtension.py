...
# --- UCSF Chimera Copyright ---
#
# $Id: ChimeraExtension.py 34055 2011-07-19 23:42:35Z pett $
...
import ModelPanel
ModelPanel.addButton("render attribute...", lambda models, sd=showDialog:
	sd(models, "Render"), balloon=ShowAttrEMO.help, defaultFavorite=False)
