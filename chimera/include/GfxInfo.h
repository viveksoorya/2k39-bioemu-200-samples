...
#   define GFXINFO_IMEX __attribute__((__visibility__("default")))
#  else
#   define GFXINFO_IMEX
#  endif
...
GFXINFO_IMEX extern void checkForGLError(const std::string &msg);

# ifndef WrapPy

extern "C" {
#ifdef _WIN32
typedef PROC (WINAPI* GetProcAddrType)(const CHAR*);
#else
...
GFXINFO_IMEX extern void	*getCurrentContext();
...
enum Features {
	...
	BlendFuncSeparate,
	WindowPos,
	Shadows,		// implies multitexturing and depth textures
	...
	// standard OpenGL 3.1 features
	DrawElementsInstanced,

	// standard OpenGL 3.2 features
	SeamlessCubeMap,

	// standard OpenGL 3.3 features
	VertexAttribDivisor,
	...
	// Features to handle OpenGL bugs or poor performance
	TrustNormals,
	AntialiasLines,
	AntialiasPoints,
	...
	FastMultisampling,
	FBOShadows,
	LimitVertexAttribDivisor,
	BrokenAttribLocation,
...
GFXINFO_IMEX extern void	disable(Features f);
...
inline bool hasVertexAttrib() { return has(VertexAttrib); }
...
// standard OpenGL 3.1 features
inline bool hasDrawElementsInstanced() { return has(DrawElementsInstanced); }

// standard OpenGL 3.2 features
inline bool hasSeamlessCubeMap() { return has(SeamlessCubeMap); }

// standard OpenGL 3.3 features
inline bool hasVertexAttribDivisor() { return has(VertexAttribDivisor); }
...
struct GFXINFO_IMEX CurrentFuncs
{
	...
	// VertexAttribDivisor
	PFNGLVERTEXATTRIBDIVISORARBPROC	vertexAttribDivisor;
...
# elif defined(GFXINFO_NSOPENGL)
	// nsopengl has no extensions yet
...
inline void
getAttachedShaders(GLuint program, GLsizei maxCount, GLsizei *count, GLuint *shaders)
{ conFuncs->getAttachedShaders(program, maxCount, count, shaders); }
inline void
bindAttribLocation(GLuint program, GLuint index, const GLchar *name)
{ conFuncs->bindAttribLocation(program, index, name); }
inline GLint
...
{ conFuncs->disableVertexAttribArray(index); }
inline void
enableVertexAttribArray(GLuint index)
{ conFuncs->enableVertexAttribArray(index); }
inline void
vertexAttribPointer(GLuint index, GLint size, GLenum type, GLboolean normalized,
		    GLsizei stride, const GLvoid *pointer)
{ conFuncs->vertexAttribPointer(index, size, type, normalized, stride, pointer); }
inline void
vertexAttrib3f(GLuint index, GLfloat v0, GLfloat v1, GLfloat v2)
{ conFuncs->vertexAttrib3f(index, v0, v1, v2); }
inline void
vertexAttrib4f(GLuint index, GLfloat v0, GLfloat v1, GLfloat v2, GLfloat v3)
{ conFuncs->vertexAttrib4f(index, v0, v1, v2, v3); }
inline void
vertexAttrib3fv(GLuint index, const GLfloat *v)
{ conFuncs->vertexAttrib3fv(index, v); }
inline void
vertexAttrib4fv(GLuint index, const GLfloat *v)
{ conFuncs->vertexAttrib4fv(index, v); }
...
inline void
framebufferTexture2D(GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLuint level)
{ conFuncs->framebufferTexture2D(target, attachment, textarget, texture, level); }
inline void
generateMipmap(GLenum target)
{ conFuncs->generateMipmap(target); }
...
{ conFuncs->drawElementsInstanced(mode, count, type, indices, primcount); }

// VertexAttribDivisor
inline void
vertexAttribDivisor(GLuint index, GLuint divisor)
{ conFuncs->vertexAttribDivisor(index, divisor); }
