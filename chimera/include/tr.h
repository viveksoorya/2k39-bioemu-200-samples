...
extern void trResetProjection(TRcontext *tr);

extern void trWindowSize(TRcontext *tr, GLsizei width, GLsizei height);

extern void trViewport(TRcontext *tr,
		      GLint x, GLint y, GLsizei width, GLsizei height);

extern int trScissor(TRcontext *tr,
	             GLint x, GLint y, GLsizei width, GLsizei height);

extern void trOffsetViewport(TRcontext *tr, GLint dx, GLint dy);
