#ifndef molecule_molecule_config_h
# define molecule_molecule_config_h
...
#   define MOLECULE_IMEX __attribute__((__visibility__("default")))
#  else
#   define MOLECULE_IMEX
#  endif
# elif defined(MOLECULE_EXPORT)
#  define MOLECULE_IMEX __declspec(dllexport)
# else
#  define MOLECULE_IMEX __declspec(dllimport)
# endif
...
# ifdef CHIMERA_NSOPENGL
#  ifndef GFXINFO_NSOPENGL
#   define GFXINFO_NSOPENGL
#  endif
# endif
