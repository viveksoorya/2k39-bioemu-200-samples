...
// --- UCSF Chimera Copyright ---
//
// $Id: Scene.h 37548 2012-10-10 16:56:26Z goddard $
...
public:
	...
	virtual			~Scene();
	void			nameNode(const char *name, Node *node);
...
#ifdef OGLFONT
	mutable NodeFontStyle	*fontStyle_;
	bool			hasTextNode_;
#endif
public:
	bool			render(bool ortho = false,
				       bool color = true,
				       bool lit = true,
				       bool singleLayerTransparency = true);
	GLUquadric *	quadric();
...
#ifdef OGLFONT
	void			setHasTextNode();
	NodeFontStyle	*fontStyle() { return fontStyle_; }
#endif
#endif
#ifdef DISPLAY
protected:
