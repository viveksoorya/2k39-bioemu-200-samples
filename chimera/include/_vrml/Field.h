...
// --- UCSF Chimera Copyright ---
//
// $Id: Field.h 38832 2013-06-12 00:49:46Z conrad $
...
public:
	...
	virtual void	addEscapedSFString(const char * /*value*/)		{ error_++; }
...
public:
	...
	virtual void	addEscapedSFString(const char *value);
	virtual void	print(std::ostream &s, int indent) const;
	virtual void	x3dWrite(std::ostream &s) const;
};
...
inline void SFString::addEscapedSFString(const char *value) { setEscaped(value); }
...
public:
	...
	virtual void	addEscapedMFString(const char *value);
	virtual void	print(std::ostream &s, int indent) const;
	virtual void	x3dWrite(std::ostream &s) const;
};
...
inline void MFString::addEscapedMFString(const char *value)
					{ FDString s; s.setEscaped(value); push_back(s); }
...
inline void addEscapedSFString(Field *f, const char *value)
					{ if (f) f->addEscapedSFString(value); }
inline void addMFString(Field *f, const char *value)
					{ if (f) f->addMFString(value); }
inline void addEscapedMFString(Field *f, const char *value)
					{ if (f) f->addEscapedMFString(value); }
