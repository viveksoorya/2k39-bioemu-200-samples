...
// --- UCSF Chimera Copyright ---
//
// $Id: FieldData.h 38832 2013-06-12 00:49:46Z conrad $
...
inline void		FDRotation::set(const float v[4])
					{ float len = sqrt(v[0] * v[0] + v[1] * v[1] + v[2] * v[2]);
					  if (len == 0) {
						value_[0] = value_[1] = value_[2] = value_[3] = 0.0f;
					  } else {
						value_[0] = v[0] / len; value_[1] = v[1] / len;
					    value_[2] = v[2] / len; value_[3] = v[3];
					  }
					}
...
public:
	...
	void	setEscaped(const char *s);
	char *	get() const;
	FDString &
			operator=(const FDString &other); operator const char *() const;
