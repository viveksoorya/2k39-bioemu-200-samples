...
public:
	...
	bool		dynamicSubdivision() const;
	void		setDynamicSubdivision(bool dyn);
	...
	static Reason DYNAMIC_SUBDIVISION_CHANGE;
...
private:
	...
	float		q;		// quality
	bool		ds;		// use dynamic subdivision
	float		ts;		// tile scale
...
inline bool
LODControl::dynamicSubdivision() const
{
	return ds;
}
