 ...
 *
 * $Id: Camera.h 38311 2013-02-20 22:15:42Z goddard $
 */
...
# endif
	...
	// Extent is visible width measured at position center()[2].
	double		extent() const;
...
# endif
	...
	void		viewport(/*OUT*/ Array<int, 4> *vp) const;
	...
	void		viewport(View v, /*OUT*/ Array<int, 4> *vp) const;
	void		eyePos(View v, /*OUT*/ Array<double, 3> *pos) const;
	void		atPos(View v, /*OUT*/ Array<double, 3> *pos) const;
	void		upDir(View v, /*OUT*/ Array<double, 3> *dir) const;

	// window() returns left, right, bottom, top, hither, yon, focal
	// l, r, b, t are at near clip plane. h, y, f are distance from eye.
	void		window(View v, /*OUT*/ Array<double, 7> *w) const;

	double		pixelSize(double z, View v = 0) const;
	...
	void		projMatrix(View v, /*OUT*/ Array<double, 16> *proj) const;
...
# ifndef WrapPy
	...
	bool		setupView(const Viewer *viewer, View v) const;
...
inline void
Camera::setCenter(double c[3])
{
	setCenter(c[0], c[1], c[2]);
}

inline void
Camera::setCenter(const Point &p)
{
