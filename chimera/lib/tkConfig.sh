...
TK_LIBS='-L/usr/lib64 -lX11 -lXss -lXext -lXft -lXrender -lfreetype -lX11 -lfontconfig   -lfontconfig  -lpthread -ldl -lz  -lpthread -lm'

# Top-level directory in which Tk's platform-independent files are
# installed.
TK_PREFIX='/tmp/chimerama77p2ll/build/foreign/tk8.6.10'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/tmp/chimerama77p2ll/build/foreign/tk8.6.10'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/tmp/chimerama77p2ll/build/foreign/src/tk8.6.10/unix -ltk8.6'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/tmp/chimerama77p2ll/build/foreign/tk8.6.10/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/tmp/chimerama77p2ll/build/foreign/tk8.6.10/include'
...
# compiled.
TK_SRC_DIR='/tmp/chimerama77p2ll/build/foreign/src/tk8.6.10'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/tmp/chimerama77p2ll/build/foreign/src/tk8.6.10/unix -ltkstub8.6'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/tmp/chimerama77p2ll/build/foreign/tk8.6.10/lib -ltkstub8.6'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/tmp/chimerama77p2ll/build/foreign/src/tk8.6.10/unix/libtkstub8.6.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/tmp/chimerama77p2ll/build/foreign/tk8.6.10/lib/libtkstub8.6.a'
