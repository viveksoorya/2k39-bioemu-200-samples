...
class Fragment(object):
    ...
    def create_bonds_by_distance(self):
        for n, atm1 in enumerate(self.atom_list):
            for atm2 in self.atom_list[n+1:]:
                if (atm1.alt_loc != "" and atm2.alt_loc != "" and atm1.alt_loc != atm2.alt_loc):
                    continue
                dist = AtomMath.calc_distance(atm1, atm2)
                edesc1 = Library.library_get_element_desc(atm1.element)
                edesc2 = Library.library_get_element_desc(atm2.element)
                if edesc1 is None or edesc2 is None:
                    continue
