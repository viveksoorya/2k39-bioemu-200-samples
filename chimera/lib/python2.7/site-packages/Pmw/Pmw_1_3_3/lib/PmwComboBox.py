...
class ComboBox(Pmw.MegaWidget):
    ...
    def destroy(self):
	# the process of destroying the megawidget can cause Configure
	# events on the parts that haven't been destroyed yet
	self._arrowBtn.unbind('<Configure>')
	self._entryWidget.unbind('<Configure>')
    ...
    def _postList(self, event = None):
        ...
        self._popup.wm_attributes('-topmost', 1)  # Needed in Aqua Tk 8.5.2.
